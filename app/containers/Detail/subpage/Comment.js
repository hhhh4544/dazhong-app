...
export default class Comment extends Component{
    ...
    render(){
        return (
            ...
            <div>
                {this.state.data.length? <CommentComponent  data={this.state.data}></CommentComponent>:<div>loading</div>}
                <LoadMore isLoading={this.state.isLoading} hasMore={this.state.hasMore} loadMore={this.loadMore.bind(this)}></LoadMore>
            </div>
        )
    }
    componentWillMount(){
